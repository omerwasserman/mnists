...
from print_loss import print_train_loss_graph
...
images_REG_test, labels_REG_test, images_INV_test, labels_INV_test = data_utils.load_processed_data_part_2()
...
train_loader = data_utils.create_loader(images_train_set - train_mean, labels_train_set)
val_loader = data_utils.create_loader(images_val_set - train_mean, labels_val_set)
test_loader_REG = data_utils.create_loader(images_REG_test - train_mean, labels_REG_test)
test_loader_INV = data_utils.create_loader(images_INV_test - train_mean, labels_INV_test)
...
print_train_loss_graph('data_part_2_train.csv')
