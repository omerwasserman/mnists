...
images_REG_test, labels_REG_test = data_utils.load_processed_data_part_3(SECTION_PATH)
...
train_loader = data_utils.create_loader(images_REG_train - train_mean, labels_REG_train, batch_size=64)
val_loader = data_utils.create_loader(images_REG_val - train_mean, labels_REG_val, batch_size=64)
test_loader = data_utils.create_loader(images_REG_test - train_mean, labels_REG_test, batch_size=64)
...
if train:
    ...
    fix_loss_data('data_part_3_train.csv', SECTION_PATH)
...
print_train_loss_graph('data_part_3_train.csv', SECTION_PATH)
