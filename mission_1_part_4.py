...
images_test, labels_test = data_utils.load_processed_data_part_4()
...
train_loader = data_utils.create_loader(images_train - train_mean, labels_train)
val_loader = data_utils.create_loader(images_val - train_mean, labels_val)
test_loader = data_utils.create_loader(images_test - train_mean, labels_test)
...
print_train_loss_graph('data_part_4_train.csv')
